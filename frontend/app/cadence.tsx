...
export default function CadenceScreen() {
  ...
  const RITUELS: Record<string, DailyRitual[]> = {
    matin: [
      { id: 'reveil', type: 'ancrage', title: 'Réveil en conscience', description: 'Avant de te lever, pose tes mains sur ton cœur. Sens 3 battements. Tu es vivant, c\'est un cadeau.', duration: '1 min', completed: false },
      { id: 'intention', type: 'intention', title: 'Intention du jour', description: 'Choisis un mot qui guidera ta journée. Pas un objectif, mais une énergie à incarner.', duration: '2 min', completed: false, requiresInput: true, inputPlaceholder: 'Mon mot du jour est...' },
      { id: 'breath_coherence', type: 'respiration', title: 'Cohérence cardiaque', description: 'Respire en 5-5 : 5 secondes inspire, 5 secondes expire. 6 cycles complets. Ton cœur et ton cerveau s\'alignent.', duration: '2 min', completed: false },
      { id: 'energy_shake', type: 'energie', title: 'Éveil énergétique', description: 'Debout, secoue tout ton corps pendant 30 secondes. Bras, jambes, tête. Réveille chaque cellule !', duration: '1 min', completed: false },
      { id: 'affirmation', type: 'affirmation', title: 'Affirmation miroir', description: 'Regarde-toi dans les yeux et dis : "Je suis capable. Je suis digne. Je suis prêt(e)."', duration: '1 min', completed: false },
      { id: 'gratitude_matin', type: 'gratitude', title: 'Gratitude préventive', description: 'Remercie à l\'avance pour 3 bonnes choses qui vont arriver aujourd\'hui.', duration: '2 min', completed: false, requiresInput: true, inputPlaceholder: 'Je remercie à l\'avance pour...' },
      { id: 'sonore', type: 'sonore', title: 'Vibration du matin', description: 'Fredonne "OM" ou un son grave pendant 30 secondes. Sens la vibration dans ta poitrine.', duration: '1 min', completed: false },
    ],
    'apres-midi': [
      { id: 'pause', type: 'silence', title: 'Micro-pause sacrée', description: 'Arrête tout. Ferme les yeux. Observe 3 sons autour de toi sans les juger.', duration: '2 min', completed: false },
      { id: '5_4_3_2_1', type: 'sensoriel', title: 'Ancrage sensoriel', description: '5 choses que tu vois, 4 que tu touches, 3 que tu entends, 2 que tu sens, 1 que tu goûtes.', duration: '3 min', completed: false },
      { id: 'liberation', type: 'liberation', title: 'Souffle de libération', description: 'Inspire par le nez, expire fort par la bouche en faisant "HA!". Libère ce qui pèse. 5 fois.', duration: '2 min', completed: false },
      { id: 'stretch_desk', type: 'etirement', title: 'Étirements conscients', description: 'Étire ton cou vers chaque côté (10s), hausse les épaules vers les oreilles, relâche d\'un coup.', duration: '3 min', completed: false },
      { id: 'introspection', type: 'introspection', title: 'Question profonde', description: 'Ferme les yeux et demande-toi : "Qu\'est-ce que mon corps essaie de me dire ?"', duration: '2 min', completed: false, requiresInput: true, inputPlaceholder: 'Mon corps me dit que...' },
      { id: 'creativite', type: 'ecriture', title: 'Écriture automatique', description: 'Écris sans t\'arrêter pendant 2 minutes. Ne réfléchis pas, laisse couler les mots.', duration: '2 min', completed: false },
      { id: 'marche', type: 'marche', title: 'Marche méditative', description: 'Marche 20 pas très lentement. Sens le transfert de poids, le contact avec le sol.', duration: '3 min', completed: false },
    ],
    soir: [
      { id: 'transition', type: 'silence', title: 'Rituel de transition', description: 'Change de vêtements, lave ton visage à l\'eau fraîche. Tu passes du mode "faire" au mode "être".', duration: '3 min', completed: false },
      { id: 'detox', type: 'liberation', title: 'Lâcher prise', description: 'Écris sur un papier ce qui t\'a dérangé aujourd\'hui. Puis froisse-le et jette-le.', duration: '2 min', completed: false },
      { id: 'body_scan', type: 'introspection', title: 'Scan corporel complet', description: 'Allongé(e), parcours mentalement chaque partie du corps. Relâche chaque tension trouvée.', duration: '5 min', completed: false },
      { id: 'bilan', type: 'bilan', title: 'Les 3 roses et l\'épine', description: '3 moments positifs (roses) et 1 difficulté (épine) de ta journée. L\'épine t\'apprend quelque chose.', duration: '4 min', completed: false, requiresInput: true, inputPlaceholder: 'Mes 3 roses : ... Mon épine : ...' },
      { id: 'pardon', type: 'gratitude', title: 'Auto-compassion', description: '"Je me pardonne pour... Je suis humain(e). Demain est un nouveau départ."', duration: '2 min', completed: false },
      { id: 'visualisation', type: 'meditation', title: 'Voyage intérieur', description: 'Imagine-toi dans ton lieu de paix idéal. Ressens l\'air, les couleurs, l\'ambiance. Reste-y 2 minutes.', duration: '3 min', completed: false },
      { id: 'gratitude_soir', type: 'gratitude', title: 'Gratitudes du jour', description: 'Nomme 3 petites joies : un sourire, une saveur, un rayon de soleil... Les petites choses comptent.', duration: '2 min', completed: false, requiresInput: true, inputPlaceholder: '1. ...\n2. ...\n3. ...' },
      { id: 'breath_sommeil', type: 'respiration', title: 'Respiration 4-7-8', description: 'Inspire 4s, retiens 7s, expire 8s. Cette respiration active ton système parasympathique pour dormir.', duration: '3 min', completed: false },
    ],
  };
